## Attribution
This project is a fork of https://github.com/pacemaker82/Compact-Power-Card by @pacemaker82.
All original credit belongs to the author.
This fork contains local modifications (using my friend [Claude](https://www.claude.com/product/claude-code)) to suit my custom 'off-grid' solar installation.

<img width="760" height="286" alt="{010D150C-8B3F-4EAC-A65D-1036CF797096}" src="https://github.com/craigusus/Compact-Power-Card-CF/blob/main/Animation.gif" />   

```yaml
type: custom:compact-power-card-cf
entities:
  pv:
    entity: sensor.controller_house_current_solar_watts_safe
    labels:
      - entity: sensor.controller_house_solar_ampers
      - entity: sensor.controller_house_solar_voltage
  grid:
    entity: sensor.tapo_meter_8_solar_charger_current_consumption
    invert_state_values: true
    icon: mdi:battery-charging-outline
  battery:
    show_soc: true
    entity: sensor.tapo_meter_1_inverter_current_consumption
    battery_soc: sensor.renogy_solar_batteries_level
  battery_labels:
    - entity: sensor.renogy_battery_1_battery_level
    - entity: sensor.renogy_battery_2_battery_level
  home:
    entity: sensor.tapo_meter_1_inverter_current_consumption
